...
#
# def last_finished_games(
#     finished_games: list[LichessFinishedGameWithMetadata],
# ) -> html_tag:
#     th_classes = "p-2"
#
#     return div(
...
#             ),
#             tbody(
#                 *[_finished_game_row(game) for game in finished_games]
#                 if finished_games
#                 else tr(
#                     td(
#                         div(
#                             "You have no recently finished games on Lichess at the moment",
#                             cls="italic p-8 text-center",
#                         ),
#                         colspan=4,
#                     )
...
#
# def _finished_game_row(game: LichessFinishedGameWithMetadata) -> tr:
#     td_classes = "border border-slate-300 dark:border-slate-700 p-1 text-slate-500 dark:text-slate-400"
#     return tr(
#         td(
#             a(
