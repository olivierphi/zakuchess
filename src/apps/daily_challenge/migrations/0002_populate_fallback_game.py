...
def _create_fallback_game(apps, schema_editor):
    ...
    # doesn't have its "clean" method: let's compute the `*_before_bot_first_move`
    # fields manually:
    from apps.daily_challenge.business_logic import compute_fields_before_bot_first_move

    compute_fields_before_bot_first_move(challenge)
