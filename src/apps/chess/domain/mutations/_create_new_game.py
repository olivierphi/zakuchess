...
if TYPE_CHECKING:
    from ..types import FEN, PieceRoleBySquare, PlayerSide
...
def create_new_game(
    *,
    ...
    game = Game.objects.create(
        ...
        piece_role_by_square=piece_role_by_square if piece_role_by_square else _STARTING_PIECES_IDS_PER_SQUARE,
        bot_side=bot_side,
    )
