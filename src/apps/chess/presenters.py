...
if TYPE_CHECKING:
    from .domain.types import TeamMember, TeamMemberRole
...
class SelectedPiecePresenter:
    def __init__(self, *, chess_board: chess.Board, piece_square: Square, target_to_confirm: Square | None):
    ...
    def is_potential_capture(self, square: Square) -> bool:
        return square in self.available_targets and self._chess_board.piece_at(chess.parse_square(square)) is not None
