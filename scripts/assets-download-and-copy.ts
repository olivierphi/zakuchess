...
const STATIC_FOLDER = "./frontend/public/assets";
const DOWNLOADS_CONCURRENCY = 3;

const ASSETS_PATTERNS: Record<string, string> = {
  STOCKFISH_CDN:
    "https://cdnjs.cloudflare.com/ajax/libs/stockfish.js/10.0.2/%(file)s",
...
const ASSETS_TO_DOWNLOAD_MAP: Record<URL, string> = Object.fromEntries([
  ...
  // "The bad folks" units:
  [sprintf(ASSETS_PATTERNS["WESNOTH_UNITS_GITHUB"], {path:"undead-skeletal/deathblade.png"}), `${STATIC_FOLDER}/img/chess/units/undead/pawn.png`],
  [sprintf(ASSETS_PATTERNS["WESNOTH_UNITS_GITHUB"], {path:"undead-skeletal/chocobone.png"}), `${STATIC_FOLDER}/img/chess/units/undead/knight.png`],
  [sprintf(ASSETS_PATTERNS["WESNOTH_UNITS_GITHUB"], {path:"undead-skeletal/banebow.png"}), `${STATIC_FOLDER}/img/chess/units/undead/bishop.png`],
  [sprintf(ASSETS_PATTERNS["WESNOTH_UNITS_GITHUB"], {path:"monsters/skeletal-dragon/skeletal-dragon.png"}), `${STATIC_FOLDER}/img/chess/units/undead/rook.png`],
  [sprintf(ASSETS_PATTERNS["WESNOTH_UNITS_GITHUB"], {path:"undead-necromancers/necromancer+female.png"}), `${STATIC_FOLDER}/img/chess/units/undead/queen.png`],
  [sprintf(ASSETS_PATTERNS["WESNOTH_UNITS_GITHUB"], {path:"undead-skeletal/draug.png"}), `${STATIC_FOLDER}/img/chess/units/undead/king.png`],
