...
WEBUI_STATIC = BASE_DIR / "public" / "assets" / "webui"
CHESS_STATIC = BASE_DIR / "public" / "assets" / "chess"
...
ASSETS_MAP: dict[URL, Path] = {
    ...
    # "The bad folks" units:
    ASSETS_PATTERNS["WESNOTH_UNITS_GITHUB"].format(path="undead-skeletal/deathblade.png"): CHESS_STATIC / "units" / "undead" / "pawn.png",
    ASSETS_PATTERNS["WESNOTH_UNITS_GITHUB"].format(path="undead-skeletal/chocobone.png"): CHESS_STATIC / "units" / "undead" / "knight.png",
    ASSETS_PATTERNS["WESNOTH_UNITS_GITHUB"].format(path="undead-skeletal/banebow.png"): CHESS_STATIC / "units" / "undead" / "bishop.png",
    ASSETS_PATTERNS["WESNOTH_UNITS_GITHUB"].format(path="monsters/skeletal-dragon/skeletal-dragon.png"): CHESS_STATIC / "units" / "undead" / "rook.png",
    ASSETS_PATTERNS["WESNOTH_UNITS_GITHUB"].format(path="undead-necromancers/necromancer+female.png"): CHESS_STATIC / "units" / "undead" / "queen.png",
    ASSETS_PATTERNS["WESNOTH_UNITS_GITHUB"].format(path="undead-skeletal/draug.png"): CHESS_STATIC / "units" / "undead" / "king.png",
